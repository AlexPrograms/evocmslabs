...
<?php $__env->startSection('content'); ?>
    <h1>
        <i class="<?php echo e($_style['icon_elements']); ?>"></i><?php echo e(ManagerTheme::getLexicon('element_management')); ?>
        ...
        <div class="tab-pane" id="resourcesPane">
            ...
            <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($tab instanceof EvolutionCMS\Interfaces\ManagerTheme\TabControllerInterface): ?>
                    <?php echo $__env->make(ManagerTheme::getViewName($tab->getView()), $tab->getParameters(), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php else: ?>
                    <?php echo $tab; ?>
...
<?php echo $__env->make('manager::template.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:/xampp/htdocs/test1/manager//views//page/resources.blade.php ENDPATH**/ ?>