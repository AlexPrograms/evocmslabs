<div class="tab-page <?php echo e($tabPageName); ?>" id="<?php echo e($tabIndexPageName); ?>">
    <h2 class="tab">
        <a href="?a=76&tab=<?php echo e($index); ?>"><i class="<?php echo e($_style['icon_template']); ?>"></i><?php echo e(ManagerTheme::getLexicon('manage_templates')); ?></a>
    </h2>
    ...
    <div id="<?php echo e($tabIndexPageName); ?>-info" class="msg-container" style="display:none">
        <div class="element-edit-message-tab"><?php echo ManagerTheme::getLexicon('template_management_msg'); ?></div>
        ...
        <form class="btn-group form-group form-inline">
            <div class="input-group input-group-sm">
                ...
                <div class="input-group-btn">
                    <a class="btn btn-success" target="main" href="<?php echo e((new EvolutionCMS\Models\SiteTemplate)->makeUrl('actions.new')); ?>">
                        <i class="<?php echo e($_style['icon_add']); ?>"></i>
                        <span><?php echo e(ManagerTheme::getLexicon('new_template')); ?></span>
                    </a>
                ...
                <?php $__env->startComponent('manager::partials.panelCollapse', ['name' => $tabIndexPageName . '_content', 'id' => 0, 'title' => ManagerTheme::getLexicon('no_category')]); ?>
                    <ul class="elements">
                        <?php $__currentLoopData = $outCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('manager::page.resources.elements.template', compact('item', 'tabIndexPageName'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('scripts.bot'); ?>
    <script>
      ...
      initViews('tmp', '<?php echo e($tabIndexPageName); ?>', '<?php echo e($tabIndexPageName); ?>_content');
    </script>
<?php $__env->stopPush(); ?>
<?php /**PATH C:/xampp/htdocs/test1/manager//views//page/resources/templates.blade.php ENDPATH**/ ?>