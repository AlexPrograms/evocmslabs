...
<head>
    ...
    <base href="<?php echo e(MODX_MANAGER_URL); ?>">
    ...
    <script type="text/javascript">
        ...
        evo.MODX_MANAGER_URL = '<?php echo e(MODX_MANAGER_URL); ?>';
        evo.config.which_browser = '<?php echo e($modx->getConfig('which_browser')); ?>';
    </script>
...
<?php /**PATH C:/xampp/htdocs/test1/manager//views//partials/header.blade.php ENDPATH**/ ?>