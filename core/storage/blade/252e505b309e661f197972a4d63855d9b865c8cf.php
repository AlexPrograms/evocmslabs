<?php $__env->startSection('content'); ?>
        ...
        <script>
          ...
          var actions = {
            save: function() {
              ...
              if (confirm('<?php echo e(ManagerTheme::getLexicon('confirm_duplicate_record')); ?>') === true) {
                documentDirty = false;
                document.location.href = "index.php?id=<?php echo e($data->getKey()); ?>&a=105";
              }
            }, delete: function() {
              if (confirm('<?php echo e(ManagerTheme::getLexicon('confirm_delete_plugin')); ?>') === true) {
                documentDirty = false;
          ...
          function createAssignEventsButton()
          {
            if (document.getElementById('assignEvents') === null) {
              ...
              button.innerHTML = '<a class="btn btn-primary" href="javascript:;" onclick="assignEvents();return false;"><?php echo e(ManagerTheme::getLexicon('set_automatic')); ?></a>';
          ...
          var internal = <?php echo $internal; ?>;
    ...
    <form name="mutate" method="post" action="index.php" enctype="multipart/form-data">
        <?php echo get_by_key($events, 'OnPluginFormPrerender'); ?>
        ...
        <h1>
            <i class="<?php echo e($_style['icon_plugin']); ?>"></i>
            <?php if($data->name): ?>
                <?php echo e($data->name); ?>

                <small>(<?php echo e($data->getKey()); ?>)</small>
            <?php else: ?>
                <?php echo e(ManagerTheme::getLexicon('new_plugin')); ?>
        ...
        <div class="container element-edit-message">
            <div class="alert alert-info"><?php echo e(ManagerTheme::getLexicon('plugin_msg')); ?></div>
        </div>

        <div class="tab-pane" id="pluginPane">
            <script>
              var tpSnippet = new WebFXTabPane(document.getElementById('pluginPane'), <?php echo e(get_by_key($modx->config, 'remember_last_tab') ? 1 : 0); ?>);
            </script>
            ...
            <div class="tab-page" id="tabPlugin">
                        ...
                        <div class="form-row">
                            <label for="disabled">
                                ...
                                <?php if($data->disabled == 1): ?>
                                    <span class="text-danger"><?php echo e(ManagerTheme::getLexicon('plugin_disabled')); ?></span>
                                <?php else: ?>
                                    <?php echo e(ManagerTheme::getLexicon('plugin_disabled')); ?>
                ...
                <div class="navbar navbar-editor">
                    <span><?php echo e(ManagerTheme::getLexicon('plugin_code')); ?></span>
                </div>
            ...
            <div class="tab-page" id="tabEvents">
                <h2 class="tab"><?php echo e(ManagerTheme::getLexicon('settings_events')); ?></h2>
                <script>tpSnippet.addTabPage(document.getElementById('tabEvents'));</script>

                <div class="container container-body">
                    <p><?php echo e(ManagerTheme::getLexicon('plugin_event_msg')); ?></p>
                    <?php
                    // get selected events
                    if ($data->getKey() > 0) {
            ...
            <?php echo get_by_key($events, 'OnPluginFormRender'); ?>
...
<?php echo $__env->make('manager::template.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:/xampp/htdocs/test1/manager//views//page/plugin.blade.php ENDPATH**/ ?>