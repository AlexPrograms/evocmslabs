<?php $__env->startSection('content'); ?>
    ...
    <form name="mutate" method="post" action="index.php">
        ...
        <h1>
            <i class="<?php echo e($_style['icon_template']); ?>"></i>
            <?php if($data->templatename): ?>
                <?php echo e($data->templatename); ?><small>(<?php echo e($data->getKey()); ?>)</small>
            <?php else: ?>
            ...
            <div class="tab-page" id="tabTemplate">
                ...
                <div class="container container-body">
                    ...
                    <div class="form-group" id="assigned-blade-file" style="display: none;">
                        <?php echo e(ManagerTheme::getLexicon('template_assigned_blade_file')); ?>: <strong id="blade-filename"></strong>
                        ...
                        <div class="create-check" style="display: hidden;">
                            <label>
                                ...
                                <?php echo e(ManagerTheme::getLexicon('template_create_blade_file')); ?>
                        ...
                        <?php $__env->startComponent('manager::partials.panelCollapse', ['name' => 'tv_in_template', 'id' => 0, 'title' => ManagerTheme::getLexicon('no_category')]); ?>
                            <ul>
                                <?php $__currentLoopData = $tvOutCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo $__env->make('manager::page.template.tv', compact('item', 'tvSelected'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
...
<?php echo $__env->make('manager::template.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:/xampp/htdocs/test1/manager//views//page/template.blade.php ENDPATH**/ ?>