<div class="tab-page <?php echo e($tabPageName); ?>" id="<?php echo e($tabIndexPageName); ?>">
    <h2 class="tab">
        <a href="?a=76&tab=<?php echo e($index); ?>"><i class="<?php echo e($_style['icon_plugin']); ?>"></i><?php echo e(ManagerTheme::getLexicon('manage_plugins')); ?></a>
    </h2>
        ...
        <form class="btn-group form-group form-inline">
            <div class="input-group input-group-sm">
                ...
                <div class="input-group-btn">
                    <a class="btn btn-success" target="main" href="<?php echo e((new EvolutionCMS\Models\SitePlugin)->makeUrl('actions.new')); ?>">
                ...
                <?php $__env->startComponent('manager::partials.panelCollapse', ['name' => $tabIndexPageName . '_content', 'id' => 0, 'title' => ManagerTheme::getLexicon('no_category')]); ?>
                    <ul class="elements">
                        <?php $__currentLoopData = $outCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('manager::page.resources.elements.plugin', compact('item', 'tabIndexPageName'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:/xampp/htdocs/test1/manager//views//page/resources/plugins.blade.php ENDPATH**/ ?>